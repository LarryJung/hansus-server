...
public class QReactionHistory extends EntityPathBase<ReactionHistory> {
    ...
    private static final long serialVersionUID = -659808411L;
    ...
    public final com.hsmchurch.app.account.QAccount account;
    ...
    public QReactionHistory(Class<? extends ReactionHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.account = inits.isInitialized("account") ? new com.hsmchurch.app.account.QAccount(forProperty("account")) : null;
